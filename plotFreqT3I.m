...
for k = 1 : units
    ...
    % plot(Data(k).xfreq.w8, Data(k).R07.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [69/255 117/255 180/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R08.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [69/255 117/255 180/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R09.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [69/255 117/255 180/255 0.5], 'LineWidth', 1.5)

    % plot(Data(k).xfreq.w8, Data(k).R07.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [255/255 156/255 0 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R08.yfreq.mean.(char(type)).(char(dir)).w8,'--', 'Color', [255/255 156/255 0 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R09.yfreq.mean.(char(type)).(char(dir)).w8,':', 'Color', [255/255 156/255 0 0.5], 'LineWidth', 1.5)

    % bg1 = [Data(k).R01.background.sum(1) Data(k).R02.background.sum(1) Data(k).R03.background.sum(1)];
    % bg1 = [Data(k).R04.background.sum(1) Data(k).R05.background.sum(1) Data(k).R06.background.sum(1)];
    % bg2 = [Data(k).R07.background.sum(1) Data(k).R08.background.sum(1) Data(k).R09.background.sum(1)];


    % plot(Data(k).xfreq.w8, Data(k).R01.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [158/255 1/255 66/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R02.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [69/255 117/255 180/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R03.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [158/255 1/255 66/255 0.5], 'LineWidth', 1.5)

    % plot(Data(k).xfreq.w8, Data(k).R04.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [154/255 1/255 172/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R05.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [103/255 174/255 223/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R06.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [69/255 117/255 180/255 0.5], 'LineWidth', 1.5)
    % plot(Data(k).xfreq.w8, Data(k).R07.yfreq.mean.(char(type)).(char(dir)).w8,'-', 'Color', [158/255 1/255 66/255 0.5], 'LineWidth', 1.5)
    ...
    set(gca,'XScale','log')
    lim = get(gca,'xlim');
    set(gca,'xlim',[10^1 10^3.7],'xtick',[10^0 10^1 10^2 10^3],'xticklabels',{'0.1','1','10','100'},'Box','on')
