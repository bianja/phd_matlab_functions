...
%     T1
    ...
    meanT1 = median([Data(k).R04.yfreq.mean.(char(type)).(char(dir)).w8; Data(k).R05.yfreq.mean.(char(type)).(char(dir)).w8; Data(k).R06.yfreq.mean.(char(type)).(char(dir)).w8]);
    ...
    plot(Data(k).xfreq.w8, meanT1,'-', 'Color', [158/255 1/255 66/255], 'LineWidth', 2)
    plot(Data(k).xfreq.w8, meanT2,'-', 'Color', [69/255 117/255 180/255], 'LineWidth', 2)
    % plot(Data(k).xfreq.w8, meanT3,'-', 'Color', [255/255 156/255 0 0.5], 'LineWidth', 2)
